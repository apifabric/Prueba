...
@Component({
  selector: 'UserVehicle-home',
  templateUrl: './UserVehicle-home.component.html',
  styleUrls: ['./UserVehicle-home.component.scss']
})
export class UserVehicleHomeComponent implements AfterViewInit {
