...
@Component({
  selector: 'Checkpoint-home',
  templateUrl: './Checkpoint-home.component.html',
  styleUrls: ['./Checkpoint-home.component.scss']
})
export class CheckpointHomeComponent implements AfterViewInit {
