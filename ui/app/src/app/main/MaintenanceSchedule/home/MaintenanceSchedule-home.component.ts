...
@Component({
  selector: 'MaintenanceSchedule-home',
  templateUrl: './MaintenanceSchedule-home.component.html',
  styleUrls: ['./MaintenanceSchedule-home.component.scss']
})
export class MaintenanceScheduleHomeComponent implements AfterViewInit {
