...
@Component({
  selector: 'GpsDatum-home',
  templateUrl: './GpsDatum-home.component.html',
  styleUrls: ['./GpsDatum-home.component.scss']
})
export class GpsDatumHomeComponent implements AfterViewInit {
